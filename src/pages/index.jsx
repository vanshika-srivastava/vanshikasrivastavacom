...
function SocialLink({ icon: Icon, ...props }) {
  return (
    <Link className="group -m-1 p-1" {...props}>
      <Icon className="h-6 w-6 fill-gray-900 transition group-hover:fill-white-600 dark:fill-gray-400 dark:group-hover:fill-white-800" />
    </Link>
  )
}
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-300 p-7 dark:border-zinc-400/40">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
...
function Photos() {
  let rotations = ['-rotate-3', '-rotate-1', 'rotate-2', '-rotate-2', 'rotate-3']
      ...
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8 ">
        {[image1, image2, image3,image4, image5].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
              'relative aspect-[9/10] w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 sm:w-72 sm:rounded-2xl border dark:border-white-2',
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>Vanshika Srivastava - Developer</title>
        <meta
          name="description"
      ...
      <Container className="mt-9">
        <div className="max-w-4xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-4xl">
            A Developer, Technical Writer and an Open Source Advocate.
          </h1>

          <h1 className="mt-2 text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-4xl">
            Currently building in Web3 Space.
          </h1>

          <p className="mt-10 text-base text-zinc-600 dark:text-gray-200">
            Hello everyone, I'm Vanshika, a techie with an interest of finance and management.
            I love the idea of fintech applications and open source which led me to
            explore the decentralized web tech stack, blockchains and dApps. I had previously worked at
            Biconomy where I was working around Account Abstraction (ERC4337) as DevRel Engineer.
            I'm currently learning more around modularity, L2s and ethereum scaling. I enjoy working with
            developer-first products to build developer content for them and educate the dev community.
          </p>
